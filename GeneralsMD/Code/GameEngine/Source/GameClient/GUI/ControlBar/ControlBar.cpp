...
void ControlBar::init( void )
{
	...
	ini.loadDirectory( AsciiString( "Data\\INI\\Object" ), AsciiString( "CommandButton.ini" ), INI_LOAD_OVERWRITE, NULL );
	// load the command sets
	ini.loadFileDirectory( AsciiString( "Data\\INI\\CommandSet" ), INI_LOAD_OVERWRITE, NULL );
	ini.loadDirectory( AsciiString( "Data\\INI\\Object" ), AsciiString( "CommandSet.ini" ), INI_LOAD_OVERWRITE, NULL );
