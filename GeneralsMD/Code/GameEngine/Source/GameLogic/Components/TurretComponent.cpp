...
//-------------------------------------------------------------------------------------------------
Component* TurretComponent::clone() const
{
	// Create a new TurretComponent
	TurretComponent* copy = new TurretComponent();
	
	// Copy base Component members using helper method (TurretComponent has no additional members)
