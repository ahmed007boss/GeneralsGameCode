...
#define CASE_LABEL(x) case x: return #x;
	...
	CASE_LABEL(MSG_META_TOGGLE_GROUPMOVE)
	...
	CASE_LABEL(MSG_REPLENISH_INVENTORY_ITEM)
	CASE_LABEL(MSG_REPLACE_COMPONENT)
	...
	CASE_LABEL(MSG_DO_GROUPMOVETO)
	CASE_LABEL(MSG_DO_GROUPATTACKMOVETO)
	...
	CASE_LABEL(MSG_TOGGLE_HOLD_POSITION)
	CASE_LABEL(MSG_ENABLE_HOLD_POSITION_AND_GUARD)
	CASE_LABEL(MSG_GUARD_IN_PLACE)
	CASE_LABEL(MSG_GUARD_IN_PLACE_WITHOUT_PURSUIT)
	CASE_LABEL(MSG_GUARD_IN_PLACE_FLYING_UNITS_ONLY)
	CASE_LABEL(MSG_DO_RAID)
