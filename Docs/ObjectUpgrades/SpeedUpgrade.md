...
SpeedUpgrade provides speed enhancement functionality for objects that can upgrade their movement speed.

**Base Class:** [`UpgradeModule`](../../GeneralsMD/Code/GameEngine/Include/GameLogic/Module/UpgradeModule.h)

## Usage

Used by objects that can upgrade their movement speed, enhance mobility, or improve speed-related capabilities.
