...
{
	sysref = sys;
	_TheSubsystemList.initSubsystem(sys, path1, path2, NULL, "", objectFolderFileExtension);
}
                      ...
                      LPSTR lpCmdLine, Int nCmdShow )
{
	...
	*/
	...
	initSubsystem(TheScienceStore, new ScienceStore(), "Data\\INI\\Default\\Science", "Data\\INI\\Science", "Science.ini");
	...
	initSubsystem(TheArmorStore, new ArmorStore(), NULL, "Data\\INI\\Armor", "Armor.ini");
